 ...
 */
@WebServlet("/project/removeUser")
public class UnssignProjectServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		userProjectDao.unassignProject(new UserProjectBindingPojo(null, userId, projectId));
